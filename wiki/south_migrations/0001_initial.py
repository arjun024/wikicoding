...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wiki_urlpath', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wiki.Article'])),
            ('language', self.gf('django.db.models.fields.CharField')(default=u'_', max_length=512)),
        ...
        # Adding unique constraint on 'URLPath', fields ['site', 'parent', 'language', 'slug']
        db.create_unique(u'wiki_urlpath', ['site_id', 'parent_id', 'language', 'slug'])

        # Adding model 'Language'
        db.create_table(u'wiki_language', (
            ('language', self.gf('django.db.models.fields.CharField')(default=u'_', max_length=255, primary_key=True)),
            ('language_displayname', self.gf('django.db.models.fields.CharField')(default=u'_', max_length=512)),
            ('language_description', self.gf('django.db.models.fields.CharField')(default=u'_', max_length=1024)),
        ))
        db.send_create_signal(u'wiki', ['Language'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'URLPath', fields ['site', 'parent', 'language', 'slug']
        db.delete_unique(u'wiki_urlpath', ['site_id', 'parent_id', 'language', 'slug'])
        ...
        db.delete_table(u'wiki_language')
    ...
    models = {
        ...
        u'wiki.language': {
            ...
            'language': ('django.db.models.fields.CharField', [], {'default': "u'_'", 'max_length': '255', 'primary_key': 'True'}),
            'language_description': ('django.db.models.fields.CharField', [], {'default': "u'_'", 'max_length': '1024'}),
            'language_displayname': ('django.db.models.fields.CharField', [], {'default': "u'_'", 'max_length': '512'})
        },
        ...
        u'wiki.urlpath': {
            'Meta': {'unique_together': "((u'site', u'parent', u'language', u'slug'),)", 'object_name': 'URLPath'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wiki.Article']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "u'_'", 'max_length': '512'}),
