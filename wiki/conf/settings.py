...
# Yes, of course.
# This is a legacy configuration, don't casually set to False
URL_CASE_SENSITIVE = True
...
# This only applies to text articles.
# Code articles use pygments.
MARKDOWN_KWARGS = {
...
MAX_REVISIONS = getattr( django_settings, 'WIKI_MAX_REVISIONS', 0)

# Maximum age of revisions in days, 0=unlimited
MAX_REVISION_AGE = getattr( django_settings, 'MAX_REVISION_AGE', 0)

# unless this is specified, django redirects to /accounts/profile/
LOGIN_REDIRECT_URL = '/'
