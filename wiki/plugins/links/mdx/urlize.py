...
>>> md.convert('http://wikicoding.org/')
'<p><a href="http://wikicoding.org/">http://wikicoding.org/</a></p>'

>>> md.convert('go to http://wikicoding.org')
'<p>go to <a href="http://wikicoding.org">http://wikicoding.org</a></p>'

>>> md.convert('wikicoding.org')
'<p><a href="http://wikicoding.org">wikicoding.org</a></p>'
...
>>> md.convert('go to <http://wikicoding.org> now!')
'<p>go to <a href="http://wikicoding.org">http://wikicoding.org</a> now!</p>'
...
class UrlizePattern(markdown.inlinepatterns.Pattern):
    ...
    """ Return a link Element given an autolink (`http://wikicoding.org`). """
